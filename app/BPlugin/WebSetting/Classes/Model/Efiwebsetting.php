...
class Efiwebsetting extends Model {
    ...
    var $coloumlist = "set_id,set_value";
//    public $crud_setting = array("add"=>1,"search"=>1,"viewall"=>1,"export"=>1,"toggle"=>1,"import"=>0,"webservice"=>0,"publish"=>1);
//    public $crud_webservice_allowed = "set_id,set_value";


//    public $dont_truncate = 1;

    public $crud_setting = array("add"=>1,"search"=>1,"viewall"=>1,"export"=>1,"toggle"=>1,"import"=>0,"webservice"=>0,"publish"=>0,"publish_flat"=>1,"refresh"=>1);
    public $crud_webservice_allowed = "set_id,set_value";

    public $main_value = "set_value"; //untuk publish flat

    public $refreshUrl = "FetchFirebase/genericFetcher_flat/Efiwebsetting";

    public $firebasepath = "published/Efiwebsetting";

    public $dont_truncate = 1;


    public static function updateData($id,$val){
