...
class Account extends Model {
	...
	var $coloumlist = "admin_username,admin_password,admin_lastupdate,admin_aktiv,admin_email,admin_role,admin_type";
	...
	public function loadByUserLogin ()
	{
		...
		if (!$ldap) {
			$sql =
				"SELECT * FROM {$this->table_name} WHERE admin_username = '$username' AND admin_password = '$password' AND admin_aktiv = 1 ";
		} else {
			$sql =
				"SELECT * FROM {$this->table_name} WHERE admin_username = '$username' AND admin_aktiv = 1 ";
		}
