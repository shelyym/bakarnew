...
class LeapMemcache {
    ...
    public function __construct() {
        ...
        define('MEMCACHED_HOST', SystemSetting::getData('memcached_host'));
        define('MEMCACHED_PORT', SystemSetting::getData('memcached_port'));

        if(SystemSetting::getData('memcached_switch')=="off") {
