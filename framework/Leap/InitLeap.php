...
//            if (strpos($_GET['url'], 'engage/PushGateway/doPush') !== false) {
//                define('_SPPATH', $WebSetting['folder']);
//                define('_BPATH', "http://" . $WebSetting['domain'] . $WebSetting['folder']);
//            }else {
                //set PATH
                define('_SPPATH', "https://" . $WebSetting['domain'] . $WebSetting['folder']);
                define('_BPATH', "https://" . $WebSetting['domain'] . $WebSetting['folder']);
//            }
        }else {
            //set PATH
            define('_SPPATH', $WebSetting['folder']);
