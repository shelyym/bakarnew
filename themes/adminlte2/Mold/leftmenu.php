...
$arrDomainName2Icon = array(
    "Business Intelligence"=>"fa fa-dashboard",
    "LandingPage"=>"fa fa-th",
    "Loyalty_Logic"=>"fa fa-user",
    "Product"=>"fa fa-bookmark",
    "PushNot"=>"fa fa-share",
    "Setting"=>"fa fa-edit",
    "UserAndRoles"=>"fa fa-user-secret"
);
            ...
            <li class="treeview <?=$active;?>">
                ...
                <ul class="treeview-menu">
                    <? foreach ($arrList as $id => $tabclick) { ?>
                        <li id="RegistorMenu_<?= $id; ?>" <? if($id == $st){?>class="activkanMenu"<?}?>><a style="cursor: pointer;"><i
