...
(function (RightJS) {
    ...
    Fx.Move = new Class(Fx.Morph, {
        ...
        getEndPosition: function (end_position) {
            ...
            if (end_position.top) {
                end_position.y = end_position.top.toInt();
            }
            if (end_position.left) {
                end_position.x = end_position.left.toInt();
            }
            ...
            if (this.options.position == 'relative') {
                if (position == 'absolute') {
                    if (defined(end_position.x)) {
                        end_position.x += cur_position.x;
                    }
                    if (defined(end_position.y)) {
                        end_position.y += cur_position.x;
                    }
                } else {
                    if (defined(end_position.x)) {
                        end_position.x += rel_left;
                    }
                    if (defined(end_position.y)) {
                        end_position.y += rel_top;
                    }
                }
            } else if (position == 'relative') {
                if (defined(end_position.x)) {
                    end_position.x += rel_left - cur_position.x;
                }
                if (defined(end_position.y)) {
                    end_position.y += rel_top - cur_position.y;
                }
            }
            ...
            for (var key in end_position) {
                switch (key) {
                    ...
                    case 'left':
                        break;
                    case 'y':
                        end_style.top = end_position.y + 'px';
                        break;
                    case 'x':
                        end_style.left = end_position.x + 'px';
                        break;
                    default:
                        end_style[key] = end_position[key];
                }
            }
