    ...
    var Dialog = new Class(Element, {
        ...
        resize: function (end_size, with_fx) {
            ...
            if ((/^<img [^>]+>/img).test(this.content.html())) {
                ...
                if ((end_size.x + threshold) > win_size.x) {
                    end_size.x = win_size.x - threshold;
                }
                if ((end_size.y + threshold) > win_size.y) {
                    end_size.y = win_size.y - threshold;
                }
            }
