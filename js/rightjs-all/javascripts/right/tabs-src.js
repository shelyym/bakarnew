        ...
        findTabs: function () {
            ...
            for (var i = 0, list = this.tabsList.get('childNodes'); i < list.length; i++) {
                if (list[i].nodeType == 3) {
                    this.tabsList._.removeChild(list[i]);
                }
            }
...
// protected
        ...
        resizing: function (callback) {
            ...
            if (controller.__working) {
                return this.resizing.bind(this, callback).delay(100);
            }
