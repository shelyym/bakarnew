...
(function () {
    ...
    (function () {
        CKEDITOR.plugins.add("youtube", {
            lang: "en pt ja hu it fr tr ru de ar nl pl vi zh el".split(" "), init: function (a) {
                ...
                CKEDITOR.dialog.add("youtube", function () {
                    var c;
                    return {
                        title: a.lang.youtube.title, minWidth: 500, minHeight: 200,
                        contents: [{
                            id: "youtubePlugin",
                            expand: !0,
                            elements: [{
                            ...
                            if (this.getContentElement("youtubePlugin", "txtEmbed").isEnabled())a = this.getValueOf("youtubePlugin", "txtEmbed"); else {
                                ...
                                !0 === this.getContentElement("youtubePlugin", "chkResponsive").getValue() && (a += '<div style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden;">', e = 'style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;"');
                                !0 === this.getContentElement("youtubePlugin",
                                ...
                                h + '" height="' + i + '" ' + e + ' allowscriptaccess="always" ') + 'allowfullscreen="true"></embed></object>') : a = a + ('<iframe width="' + h + '" height="' + i + '" src="' + b + '" ' + e) + 'frameborder="0" allowfullscreen></iframe>';
    ...
    (function () {
        CKEDITOR.plugins.add("oembed", {
            icons: "oembed", hidpi: !0, requires: "widget,dialog", version: 1.16, init: function (d) {
                function l(a, e, c, f, i, h, g, b) {
                    jQuery("body").oembed(a, {
                        onEmbed: function (e) {
                            b.element.data("resizeType", h);
                            if ("responsive" == h || "custom" == h)b.element.data("maxWidth", c), b.element.data("maxHeight", f);
                            b.element.data("align", g);
                            "center" == g ? (b.inline || b.element.setStyle("text-align", "center"), b.element.removeStyle("float")) : (b.inline || b.element.removeStyle("text-align"), "none" == g ? b.element.removeStyle("float") :
                                b.element.setStyle("float", g));
                            "string" === typeof e.code ? (b.element.$.firstChild && b.element.$.removeChild(b.element.$.firstChild), b.element.appendHtml(e.code), b.element.data("oembed", a)) : "string" === typeof e.code[0].outerHTML ? (b.element.$.firstChild && b.element.$.removeChild(b.element.$.firstChild), b.element.appendHtml(e.code[0].outerHTML), b.element.data("oembed", a)) : alert(d.lang.oembed.noEmbedCode)
                        }, onError: function (a) {
                            0 < a.indexOf("vimeo.com") ? alert(d.lang.oembed.noVimeo) : alert(d.lang.oembed.Error)
                        },
                        maxHeight: f, maxWidth: c, useResponsiveResize: i, embedMethod: "editor"
                    })
                }
                ...
                CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
                    oEmbed: function (a, e, c, f) {
                        function i() {
                            if (null == e || "undefined" == e)e = null;
                            if (null == c || "undefined" == c)c = null;
                            if (null == f || "undefined" == f)f = !1;
                            l(a, d, !1, e, c, f)
                        }

                        if (1 > a.length || 0 > a.indexOf("http"))return alert(d.lang.oembed.invalidUrl), !1;
                        "undefined" === typeof jQuery.fn.oembed ? CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("oembed") + "libs/jquery.oembed.min.js"), function () {
                            i()
                        }) : i();
                        return !0
                    }
                });
                d.widgets.add("oembed", {
                    draggable: !1,
                    mask: !0,
                    dialog: "oembed",
                    allowedContent: {
                        div: {
                            ...
                            attributes: "*",
                            classes: null != d.config.oembed_WrapperClass ? d.config.oembed_WrapperClass : "embeddedContent"
                        }, "div iframe": {attributes: "*"}
                    },
                    template: '<div class="' + (null != d.config.oembed_WrapperClass ? d.config.oembed_WrapperClass : "embeddedContent") + '"></div>',
                    upcast: function (a) {
                        return "div" == a.name && a.hasClass(null != d.config.oembed_WrapperClass ? d.config.oembed_WrapperClass : "embeddedContent")
                    },
                    init: function () {
                        this.setData({
                ...
                d.ui.addButton("oembed", {
                    label: d.lang.oembed.button,
                    command: "oembed",
                    toolbar: "insert,10",
                    icon: this.path + "icons/" + (CKEDITOR.env.hidpi ? "hidpi/" : "") + "oembed.png"
                });
                var k = function () {
                    var a = this.getDialog(), e = this.getValue(), c = a.getContentElement("general", "maxSizeBox").getElement(),
                        a = a.getContentElement("general", "sizeBox").getElement();
                    "noresize" == e ? (c.hide(), a.hide()) : "custom" == e ? (c.hide(), a.show()) : (c.show(), a.hide())
                };
                ...
                CKEDITOR.dialog.add("oembed", function (a) {
                    return {
                        ...
                        onShow: function () {
                            ...
                            var a = this.getContentElement("general", "resizeType").getValue(), c = this.getContentElement("general", "maxSizeBox").getElement(), f = this.getContentElement("general", "sizeBox").getElement();
                            "noresize" == a ? (c.hide(), f.hide()) : "custom" == a ? (c.hide(), f.show()) :
                                (c.show(), f.hide())
                        },
                        onOk: function () {
                        },
                        contents: [{
                            ...
                            elements: [{
                                ...
                                type: "text", id: "embedCode", focus: function () {
                                    this.getElement().focus()
                                }, label: a.lang.oembed.url, title: a.lang.oembed.pasteUrl, setup: function (a) {
                                    a.data.oembed && this.setValue(a.data.oembed)
                                }, commit: function (e) {
                                    var c = CKEDITOR.dialog.getCurrent(), f = c.getValueOf("general",
                                        "embedCode").replace(/\s/g, ""), d = c.getContentElement("general", "resizeType").getValue(), h = c.getContentElement("general", "align").getValue(), g = null, b = null, j = !1, k = c.getParentEditor();
                                    if (1 > f.length || 0 > f.indexOf("http"))return alert(a.lang.oembed.invalidUrl), !1;
                                    "noresize" == d ? (j = !1, b = g = null) : "responsive" == d ? (g = c.getContentElement("general", "maxWidth").getInputElement().getValue(), b = c.getContentElement("general", "maxHeight").getInputElement().getValue(), j = !0) : "custom" == d && (g = c.getContentElement("general",
                                        "width").getInputElement().getValue(), b = c.getContentElement("general", "height").getInputElement().getValue(), j = !1);
                                    l(f, k, g, b, j, d, h, e);
                                    e.setData("oembed", f);
                                    e.setData("resizeType", d);
                                    e.setData("align", h);
                                    e.setData("maxWidth", g);
                                    e.setData("maxHeight", b)
                                }
                            }, {
                                type: "hbox", widths: ["50%", "50%"], children: [{
                                    ...
                                    items: [[a.lang.oembed.noresize, "noresize"], [a.lang.oembed.responsive,
                                        "responsive"], [a.lang.oembed.custom, "custom"]],
                                    onChange: k
                                }, {
                                    type: "hbox",
                                    id: "maxSizeBox",
                                    ...
                                    children: [{
                                        ...
                                        id: "maxHeight",
                                        width: "120px",
                                        "default": null != a.config.oembed_maxHeight ?
                                            a.config.oembed_maxHeight : "315",
                                ...
                                children: [{
                                    id: "align",
                                    type: "radio",
                                    items: [[a.lang.oembed.none, "none"], [a.lang.common.alignLeft, "left"], [a.lang.common.alignCenter, "center"], [a.lang.common.alignRight, "right"]],
    ...
    CKEDITOR.plugins.add("eqneditor", {
        availableLangs: {en: 1}, lang: "en", requires: ["dialog"], icons: "eqneditor", init: function (a) {
            ...
            CKEDITOR.scriptLoader.load([d + "latex.codecogs.com/js/eq_config.js", d + "latex.codecogs.com/js/eq_editor-lite-16.js"]);
            var c = document.createElement("link");
            c.setAttribute("rel", "stylesheet");
            c.setAttribute("type", "text/css");
            c.setAttribute("href", d + "latex.codecogs.com/css/equation-embed.css");
            document.getElementsByTagName("head")[0].appendChild(c);
            a.addCommand("eqneditorDialog", new CKEDITOR.dialogCommand("eqneditorDialog", {
                allowedContent: "img[src,alt]",
                requiredContent: "img[src,alt]"
            }));
            CKEDITOR.dialog.add("eqneditorDialog", this.path + "dialogs/eqneditor.js");
            a.ui.addButton("EqnEditor", {
                label: a.lang.eqneditor.toolbar,
                command: "eqneditorDialog",
                toolbar: "insert"
            });
            a.contextMenu && (a.addMenuGroup(a.lang.eqneditor.menu), a.addMenuItem("eqneditor", {
                label: a.lang.eqneditor.edit,
                ...
                a.contextMenu.addListener(function (a) {
                    var b = {};
                    if (a.getAscendant("img", !0) && null != a.getAttribute("src").match(/(gif|svg)\.latex\?(.*)/))return b.eqneditor = CKEDITOR.TRISTATE_OFF, b
                }));
            a.on("doubleclick", function (a) {
                var b = a.data.element;
                if (b && b.is("img") && b.getAttribute("src").match(/(gif|svg)\.latex\?(.*)/) != null) {
                    a.data.dialog = "eqneditorDialog";
                    a.cancelBubble = true;
                    a.returnValue = false;
                    a.stop()
                }
    ...
    CKEDITOR.plugins.add("imageresize", {
        init: function (b) {
            if (this.support()) {
                ...
                b.on("instanceReady", function () {
                    b.document.on("paste", function (e) {
                        var c = e.data.getTarget();
                        c || (c = b.document);
                        window.setTimeout(function () {
                            a.resizeAll(b, c, 800, 800)
                        }, 500);
                        window.setTimeout(function () {
                            a.resizeAll(b, c, 800, 800)
                        }, 1E3);
        ...
        }, resizeAll: function (b, a, e, c) {
            if (this.support() && (a || (a = b.document), a))if ("find"in a && "function" == typeof a.find || (a = new CKEDITOR.dom.node(a)), a && "find"in a && "function" == typeof a.find) {
                var a = a.find("img"), d, h, f, g, i, j = a.count();
                for (i = 0; i < j; i++) {
                    g = a.getItem(i);
                    h = d = 0;
                    f = "";
                    try {
                        d = g.$.width, h = g.$.height, f = g.getAttribute("src")
                    } catch (k) {
                        h = d = 0, f = ""
                    }
                    f && (0 === f.indexOf("data:") && (d >
                    e || h > c)) && this.resize(b, g, e, c)
                }
            }
        }, resize: function (b, a, e, c) {
            if (this.support() && a) {
                var d = new Image;
                d.ckeditorimageresize = {n: a, w: e, h: c};
                d.onerror = function () {
                ...
                d.onload = function () {
                    if (!(this.width <= this.ckeditorimageresize.w && this.height <= this.ckeditorimageresize.h)) {
                        this.ckeditorimageresize.w / this.ckeditorimageresize.h > this.width / this.height ? this.ckeditorimageresize.w =
                            this.ckeditorimageresize.h * (this.width / this.height) : this.ckeditorimageresize.h = Math.round(this.ckeditorimageresize.w / (this.width / this.height));
                        var a = document.createElement("canvas");
                        a.width = this.ckeditorimageresize.w;
                        a.height = this.ckeditorimageresize.h;
                        a.style.width = this.ckeditorimageresize.w + "px";
                        a.style.height = this.ckeditorimageresize.h + "px";
                        a.getContext("2d").drawImage(this, 0, 0, this.ckeditorimageresize.w, this.ckeditorimageresize.h);
                        if (this.ckeditorimageresize.n) {
                            this.ckeditorimageresize.n.setAttribute("src",
                            ...
                            try {
                                this.ckeditorimageresize.n.$.style.width = this.ckeditorimageresize.w + "px", this.ckeditorimageresize.n.$.style.height = this.ckeditorimageresize.h + "px"
                            } catch (c) {
                            }
                            try {
                                b.focus(), b.getSelection().scrollIntoView()
                            } catch (d) {
                            }
                        }
                        this.ckeditorimageresize = null;
        ...
        support: function () {
            if (null === this.supportResult) {
                ...
                if (b && b.getContext && b.toDataURL && b.getContext("2d") && (b = b.getContext("2d")) && b.getImageData && b.putImageData)this.supportResult = !0
            }
    ...
    CKEDITOR.plugins.add("letterspacing", {
        requires: ["richcombo"], init: function (b) {
            var e = b.config, c = [];
            e.allowedContent = "span";
            for (var d = -10; 11 > d; d++)c.push("" + d + "px");
            b.ui.addRichCombo("letterspacing", {
                label: "Tracking",
                title: "Change letter-spacing",
                voiceLabel: "Change letter-spacing",
                className: "cke_format",
                multiSelect: !1,
                panel: {css: [e.contentsCss, CKEDITOR.getUrl(CKEDITOR.skin.getPath("editor") + "editor.css")]},
                init: function () {
                    this.startGroup("letterspacing");
                    for (var a in c)this.add(c[a], c[a], c[a])
                },
                onClick: function (a) {
                    b.focus();
                    b.fire("saveSnapshot");
                    var c = b.elementPath(), a = new CKEDITOR.style({styles: {"letter-spacing": a}});
    ...
    (function () {
        Array.prototype.forEach || (Array.prototype.forEach = function (a, b) {
            var c, e;
            c = 0;
            for (e = this.length; c < e; ++c)c in this && a.call(b, this[c], c, this)
        });
        CKEDITOR.plugins.add("slideshow", {
            lang: "en,fr,ru,el,sr,sr-latn", getSlideShowDialogCss: function () {
                return "img.cke_slideShow{background-image: url(" + CKEDITOR.getUrl(this.path + "icons/placeholder.png") + ");background-position: center center;background-repeat: no-repeat;background-color:Azure;border: 1px solid #a9a9a9;width: 100px;height:100px;margin: 5px;"
            },
            icons: "slideshow", onLoad: function () {
                CKEDITOR.addCss && CKEDITOR.addCss(this.getSlideShowDialogCss())
            }, init: function (a) {
                var b = a.lang.slideshow;
                if (typeof a.element.data == "undefined")alert('The "Slide Show" plugin requires CKEditor 3.5 or newer'); else {
                    allowed = "";
                    allowed = allowed + " html head title; style [media,type]; body (*)[id]; meta link [*]";
                    allowed = allowed + "; img[*]{*}(*)";
                    allowed = allowed + "; div[*]{*}(*)";
                    allowed = allowed + "; script[*]{*}(*)";
                    allowed = allowed + "; ul[*]{*}(*)";
                    allowed = allowed + "; li[*]{*}(*)";
                    a.addCommand("slideshow", new CKEDITOR.dialogCommand("slideshowDialog", {
                        allowedContent: allowed,
                        requires: ["fakeobjects"]
                    }));
                    a.ui.addButton("Slideshow", {label: b.insertSlideShow, command: "slideshow", toolbar: "insert"});
                    a.on("load", function () {
                    });
                    a.on("doubleclick", function (a) {
                        var b = a.data.element;
                        if (b.is("img") && b.data("cke-real-element-type") == "slideShow")a.data.dialog = "slideshowDialog"
                    });
                    a.on("instanceReady", function () {
                    });
                    CKEDITOR.on("instanceReady", function (a) {
                        a.editor.on("dialogShow", function (a) {
                            CKEDITOR.env.ie &&
                            $(a.data._.element.$).find('a[href*="void(0)"]').removeAttr("href")
                        })
                    });
                    if (a.contextMenu) {
                        a.addMenuGroup("slideshowGroup");
                        a.addMenuItem("slideshowItem", {
                            label: b.editSlideShow,
                            icon: this.path + "icons/slideshow.png",
                            command: "slideshow",
                            group: "slideshowGroup"
                        });
                        a.contextMenu.addListener(function (b) {
                            if (b && b.is("img") && !b.isReadOnly() && b.data("cke-real-element-type") == "slideShow") {
                    ...
                    CKEDITOR.dialog.add("slideshowDialog", this.path +
                    "dialogs/slideshow.min.js");
                    a.addCss && a.addCss(this.getSlideShowDialogCss());
                    CKEDITOR.dtd.$empty["cke:source"] = 1;
                    CKEDITOR.dtd.$empty.source = 1;
                    a.lang.fakeobjects.slideShow = b.fakeObject
                }
            }, afterInit: function (a) {
                ...
                (b = b && b.dataFilter) && b.addRules({
                    elements: {
                        div: function (b) {
                            if (b.attributes["class"] == "slideshowPlugin") {
                                var c = a.createFakeParserElement(b, "cke_slideShow", "slideShow", false), d = c.attributes.style || "", f = CKEDITOR.getUrl("plugins/slideshow/icons/placeholder.png"),
                                    g = false;
                                ...
                                d = c.attributes.style = d + ' background-image:url("' + f + '"); ';
                                d = c.attributes.style = d + " background-size:50%; ";
                                d = c.attributes.style = d + " display:block; ";
                                return c
                            }
                        }
                    }
        ...
        CKEDITOR.skins && (en = {slideshow: en}, fr = {slideshow: fr}, ru = {slideshow: ru}, el = {slideshow: el}, sr = {slideshow: sr})
    })();
    ...
    eval(function (d, e, a, c, b, f) {
        ...
        return d
    }("i.m.9('5',{A:'z',y:'5',k:7(j){j.x.9('w',{v:'l q',n:'<b u=\"5\"><c 3=\"\" 2=\"\" 4=\"\"></c></b>',h:'f',o:'c(!5){4}{2}{3}',p:7(6){r 6.s=='b'&&6.t('5')},k:7(){1=0.6.$.g;0.e('4',1.a('4'));0.e('3',1.a('3'));0.e('2',1.a('2'))},8:7(){1=0.6.$.g;1.d('4',0.8.4);1.d('3',0.8.3);1.d('2',0.8.2)}});i.h.9('f',0.B+'C/5.D')}});",
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,64px,bold,72,64px,italic,144,64px,strike,216,64px,subscript,288,64px,superscript,360,64px,underline,432,64px,blockquote,504,64px,copy-rtl,576,64px,copy,648,64px,cut-rtl,720,64px,cut,792,64px,paste-rtl,864,64px,paste,936,64px,horizontalrule,1008,64px,image,1080,64px,indent-rtl,1152,64px,indent,1224,64px,outdent-rtl,1296,64px,outdent,1368,64px,anchor-rtl,1440,64px,anchor,1512,64px,link,1584,64px,unlink,1656,64px,bulletedlist-rtl,1728,64px,bulletedlist,1800,64px,numberedlist-rtl,1872,64px,numberedlist,1944,64px,maximize,2016,64px,pastetext-rtl,2088,64px,pastetext,2160,64px,pastefromword-rtl,2232,64px,pastefromword,2304,64px,removeformat,2376,64px,source-rtl,2448,64px,source,2520,64px,specialchar,2592,64px,scayt,2664,64px,table,2736,64px,redo-rtl,2808,64px,redo,2880,64px,undo-rtl,2952,64px,undo,3024,64px,spellchecker,3096,64px,bgcolor,3168,64px,textcolor,3240,64px,oembed,3312,64px,eqneditor,6768,auto,justifyblock,3456,64px,justifycenter,3528,64px,justifyleft,3600,64px,justifyright,3672,64px,preview-rtl,3744,64px,preview,3816,64px,selectall,3888,64px,placeholder,7920,auto,slideshow,8064,auto,sourcedialog-rtl,4104,64px,sourcedialog,4176,64px,locationmap,8496,auto', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,136,auto,italic,272,auto,strike,408,auto,subscript,544,auto,superscript,680,auto,underline,816,auto,blockquote,952,auto,copy-rtl,1088,auto,copy,1224,auto,cut-rtl,1360,auto,cut,1496,auto,paste-rtl,1632,auto,paste,1768,auto,horizontalrule,1904,auto,image,2040,auto,indent-rtl,2176,auto,indent,2312,auto,outdent-rtl,2448,auto,outdent,2584,auto,anchor-rtl,2720,auto,anchor,2856,auto,link,2992,auto,unlink,3128,auto,bulletedlist-rtl,3264,auto,bulletedlist,3400,auto,numberedlist-rtl,3536,auto,numberedlist,3672,auto,maximize,3808,auto,pastetext-rtl,3944,auto,pastetext,4080,auto,pastefromword-rtl,4216,auto,pastefromword,4352,auto,removeformat,4488,auto,source-rtl,4624,auto,source,4760,auto,specialchar,4896,auto,scayt,5032,auto,table,5168,auto,redo-rtl,5304,auto,redo,5440,auto,undo-rtl,5576,auto,undo,5712,auto,spellchecker,5848,auto,bgcolor,5984,auto,textcolor,6120,auto,oembed,6256,auto,eqneditor,6392,auto,justifyblock,6528,auto,justifycenter,6664,auto,justifyleft,6800,auto,justifyright,6936,auto,preview-rtl,7072,auto,preview,7208,auto,selectall,7344,auto,placeholder,7480,auto,slideshow,7616,auto,sourcedialog-rtl,7752,auto,sourcedialog,7888,auto,locationmap,8024,auto', 'icons.png');
    })();
