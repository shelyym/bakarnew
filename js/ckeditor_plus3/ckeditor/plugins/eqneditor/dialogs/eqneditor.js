...
CKEDITOR.dialog.add("eqneditorDialog", function (b) {
    ...
    return {
        ...
        contents: [{
            ...
            }, {type: "html", html: '<label for="CClatex' + window.CCounter + '">Equation (LaTeX):</label>'}, {
                type: "html",
        ...
        onOk: function () {
            ...
            a.setAttribute("alt", EqEditor.getTextArea().getLaTeX());
